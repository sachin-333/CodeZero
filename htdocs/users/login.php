...
if(isset($_POST['username']) and 
   isset($_POST['password']))
   {
      ...
      $login = usersession::authenticate($username, $password);
      if($login == true)
      {
         header('Location: /');
      }
                              ...
                              <div class="row">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="username" id="email" aria-describedby="email" placeholder=" ">
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
