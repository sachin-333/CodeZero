...
if (session::get('session_token')) {
  ...
  if(isset($_POST['name']) and 
    ...
    isset($_POST['income_range']))
   {
      ...
      $updateProfile = $userobj->update_profile($name, $username, $email, $phone, $profession, $income_range, $job_type);
   ...
   if(isset($_POST['old_pass']) and
   isset($_POST['new_pass']) and 
   isset($_POST['re_enter_pass']))
   {
    $old_pass = $_POST['old_pass'];
    $new_pass = $_POST['new_pass'];
    $re_enter_pass = $_POST['re_enter_pass'];

    $changePass = $userobj->changePassword($old_pass, $new_pass, $re_enter_pass, $session_token);
    if($changePass == true)
    {
        ?><script>alert('Password Updation Success!')</script><?   
    } else{
        ?><script>alert('Password Updation Failed! Please Try again!')</script><?
     }
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Profile | Gig Wallet </title>
                        ...
                        <form method="post">
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control" value="<?echo $userobj->name?>" name="name" id="fname" placeholder="Name">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="lname">Username:</label>
                                 <input type="text" class="form-control" value="<?echo $userobj->username?>" name="username" id="lname" placeholder="Username">
                              </div>
                              
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="mobno">Mobile Number:</label>
                                 <input type="number" class="form-control" value="<?echo $userobj->phone?>" name="phone" id="mobno" placeholder="Mobile Number">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="email">Email:</label>
                                 <input type="email" class="form-control" value="<?echo $userobj->email?>" name="email" id="email" placeholder="Email">
                              </div>
                              <div class="form-group col-md-6">
                                 <div class="form-group">
                                    <label class="form-label">Job Type:</label>
                                    <select name="job_type" class="selectpicker form-control" value="<?echo $userobj->job_type?>" data-style="py-0" required>
                                       ...
                                       <option>Film Artist</option>
                                       <option>Architecture</option>
                                       <option>Accountancy</option>
                                       <option>Other Freelancers</option>
                                    </select>
                                 </div>
                              </div>
                              ...
                              <div class="form-group col-md-6">
                               <!---- <div class="form-label">--->
                                   ...
                                   <select name="profession" class="selectpicker form-control" value="<?echo $userobj->profession?>" data-style="py-0">
                                      <option>Select</option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="income_range" class="selectpicker form-control" value="<?echo $userobj->income_range?>" data-style="py-0">
                           ...
                           <div class="row">
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="Old password" required >Old password:</label>
                                 <input type="password" name="old_pass" class="form-control" id="uname" placeholder="Old password">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="pass">New Password:</label>
                                 <input type="password" name="new_pass" class="form-control" id="pass" placeholder="New Password">
                              </div>
                              <div class="form-group col-md-6">
                                <label class="form-label" for="pass">Confirm New Password:</label>
                                <input type="password" name="re_enter_pass" class="form-control" id="pass" placeholder="Confirm New Password">
                             </div>
                           </div>
