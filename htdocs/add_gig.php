...
if (session::get('session_token')) {
  ...
  if(isset($_POST['gig_name']) and 
  isset($_POST['total_income']))
  {
    $gig_name = $_POST['gig_name'];
    $total_income = $_POST['total_income'];

    $create_gig = gig::create($userobj->id, $userobj->username, $gig_name, $total_income, 'yes');
    if($create_gig == true)
    {
        ?><script>alert('Gig Creation Success!')</script><?  
    }
    else{
        ?><script>alert('Gig Creation Failed!')</script><?  
    }
  }
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Add Gig | Gig Wallet </title>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/add_gig">
                        <i class="icon">
                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div>
                                  <h1>Hello <?echo $gig_obj->gig_name?>!</h1>
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Add a Gig</h4>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post">
                        <div class="form-group">
                            <div class="form-group">
                               <label class="form-label">Gig Name:</label>
                               <input type="expenses" name="gig_name" class="form-control" id="pwd">
                            </div>
                         </div>
                        <div class="form-group">
                            <label class="form-label" for="pwd">Total Income :</label>
                            <input type="expenses" name="total_income" class="form-control" id="pwd">
                        </div>
